...
class luno(Exchange, ImplicitAPI):
        ...
        return self.deep_extend(super(luno, self).describe(), {
            ...
            'urls': {
                ...
                'api': {
                    ...
                    'exchangeAjax': 'https://ajax.luno.com/ajax',
                },
    ...
    @staticmethod
    def parse_timeframe_exhange(timeframe):
    ...
    def fetch_ohlcv(self, symbol: str, timeframe='1m', since: Int = None, limit: Int = None, params={}):
        ...
        request = {
            'symbol': market['id'],
            'resolution': self.parse_timeframe_exhange(timeframe),  # allows the user to pass custom timeframes if needed
        }
        ...
        response = self.exchangeAjaxGetHistory(self.extend(request, params))
        #
        #    {
        #        "s": "ok",
        #        "t": [
    ...
    def fetch_ohlcv_private(self, symbol: str, timeframe='1m', since: Int = None, limit: Int = None, params={}):
        """
        :see: https://www.luno.com/en/developers/api#tag/Market/operation/GetCandles
        fetches historical candlestick data containing the open, high, low, and close price, and the volume of a market
        :param str symbol: unified symbol of the market to fetch OHLCV data for
        ...
        return self.parse_ohlcvs_private(ohlcvs, market, timeframe, since, limit)

    def parse_ohlcv_private(self, ohlcv, market: Market = None) -> list:
        # {
        #     "timestamp": 1664055240000,
        #     "open": "19612.65",
        #     "close": "19612.65",
